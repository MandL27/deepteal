...
extern const u32 gBattleTerrainPalette_GymNormal[];
extern const u32 gBattleTerrainPalette_GymFighting[];
extern const u32 gBattleTerrainPalette_GymFlying[];
extern const u32 gBattleTerrainPalette_GymPoison[];
extern const u32 gBattleTerrainPalette_GymGround[];
extern const u32 gBattleTerrainPalette_GymRock[];
extern const u32 gBattleTerrainPalette_GymBug[];
extern const u32 gBattleTerrainPalette_GymGhost[];
extern const u32 gBattleTerrainPalette_GymSteel[];
extern const u32 gBattleTerrainPalette_GymFire[];
extern const u32 gBattleTerrainPalette_GymWater[];
extern const u32 gBattleTerrainPalette_GymGrass[];
extern const u32 gBattleTerrainPalette_GymElectric[];
extern const u32 gBattleTerrainPalette_GymPsychic[];
extern const u32 gBattleTerrainPalette_GymIce[];
extern const u32 gBattleTerrainPalette_GymDragon[];
extern const u32 gBattleTerrainPalette_GymDark[];
extern const u32 gBattleTerrainPalette_GymFairy[];
...
extern const u16 gBattleInterface_HpBarPal[];
