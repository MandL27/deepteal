...
// TMs/HMs
    ...
    [ITEM_TM51_DRAGON_DANCE] =
    {
        .name = _("TM51"),
        .itemId = ITEM_TM51_DRAGON_DANCE,
        .price = 3000,
    ...
    [ITEM_TM57_FLARE_BLITZ] =
    {
        .name = _("TM57"),
        .itemId = ITEM_TM57_FLARE_BLITZ,
        .price = 3000,
    ...
    {
        .name = _("TM87"),
        .itemId = ITEM_TM87_DRAINING_KISS,
        .price = 3000,
    ...
    [ITEM_TM98_LIQUIDATION] =
    {
        .name = _("TM98"),
        .itemId = ITEM_TM98_LIQUIDATION,
        .price = 3000,
