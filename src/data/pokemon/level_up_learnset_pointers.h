const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
	...
	// Alolan Forms
    [SPECIES_ALOLAN_RATTATA] = sRattataAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_RATICATE] = sRaticateAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_RAICHU] = sRaichuAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_SANDSHREW] = sSandshrewAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_SANDSLASH] = sSandslashAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_VULPIX] = sVulpixAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_NINETALES] = sNinetalesAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_DIGLETT] = sDiglettAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_DUGTRIO] = sDugtrioAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_MEOWTH] = sMeowthAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_PERSIAN] = sPersianAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_GEODUDE] = sGeodudeAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_GRAVELER] = sGravelerAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_GOLEM] = sGolemAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_GRIMER] = sGrimerAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_MUK] = sMukAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_EXEGGUTOR] = sExeggutorAlolanLevelUpLearnset,
    [SPECIES_ALOLAN_MAROWAK] = sMarowakAlolanLevelUpLearnset,
    // Forms
