...
static const u8 sBurmySandyTMHMLearnset[] =
{
    TMHM(TM10_HIDDEN_POWER),
    TMHM(TM17_PROTECT),
    0xFF,
...
static const u8 sBurmyTrashTMHMLearnset[] =
{
    TMHM(TM10_HIDDEN_POWER),
    TMHM(TM17_PROTECT),
    0xFF,
...
const u8 *const gTMHMLearnsets[] =
{
    ...
    [SPECIES_BURMY_SANDY] = sBurmySandyTMHMLearnset,
    [SPECIES_BURMY_TRASH] = sBurmyTrashTMHMLearnset,
