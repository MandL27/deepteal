#define TMHM(tmhm) ((u8) ((ITEM_##tmhm) - ITEM_TM00_BODY_SLAM))
...
static const u8 sCharmanderTMHMLearnset[] =
{
    ...
    TMHM(TM39_ROCK_TOMB),
    TMHM(TM41_THUNDER_PUNCH),
    TMHM(TM42_FACADE),
    TMHM(TM44_REST),
    TMHM(TM48_FIRE_PUNCH),
    TMHM(TM50_HEAT_WAVE),
    TMHM(TM51_FLAME_CHARGE),
    TMHM(TM54_FALSE_SWIPE),
...
static const u8 sSquirtleTMHMLearnset[] =
{
    ...
    TMHM(TM43_ICE_PUNCH),
    TMHM(TM44_REST),
    TMHM(TM46_IRON_DEFENSE),
    TMHM(TM54_FALSE_SWIPE),
    TMHM(TM55_SCALD),
    TMHM(TM57_WATER_PULSE),
    TMHM(TM58_HYDRO_PUMP),
    TMHM(TM59_DRAGON_PULSE),
    TMHM(TM67_ZEN_HEADBUTT),
    TMHM(TM80_ROCK_SLIDE),
    TMHM(TM83_WORK_UP),
    TMHM(TM85_OUTRAGE),
    TMHM(TM90_SUBSTITUTE),
...
static const u8 sPikachuTMHMLearnset[] =
{
    ...
    TMHM(TM42_FACADE),
    TMHM(TM44_REST),
    TMHM(TM69_NASTY_PLOT),
    TMHM(TM72_VOLT_SWITCH),
    TMHM(TM73_THUNDER_WAVE),
    TMHM(TM79_AGILITY),
    TMHM(TM87_SHOCK_WAVE),
    TMHM(TM90_SUBSTITUTE),
    TMHM(TM92_PLAY_ROUGH),
    TMHM(TM93_WILD_CHARGE),
    TMHM(TM94_KNOCK_OFF),
    TMHM(TM96_SIGNAL_BEAM),
    TMHM(HM03_SURF),
...
const u8 *const gTMHMLearnsets[] =
{
    ...
    [SPECIES_WORMADAM_SANDY_CLOAK] = sWormadamSandyTMHMLearnset,
    [SPECIES_WORMADAM_TRASH_CLOAK] = sWormadamTrashTMHMLearnset,
    ...
    [SPECIES_MEOWSTIC_FEMALE] = sMeowsticFTMHMLearnset,
    [SPECIES_RATTATA_ALOLAN] = sAlolanRattataTMHMLearnset,
    [SPECIES_RATICATE_ALOLAN] = sAlolanRaticateTMHMLearnset,
    [SPECIES_RAICHU_ALOLAN] = sAlolanRaichuTMHMLearnset,
    [SPECIES_SANDSHREW_ALOLAN] = sAlolanSandshrewTMHMLearnset,
    [SPECIES_SANDSLASH_ALOLAN] = sAlolanSandslashTMHMLearnset,
    [SPECIES_VULPIX_ALOLAN] = sAlolanVulpixTMHMLearnset,
    [SPECIES_NINETALES_ALOLAN] = sAlolanNinetalesTMHMLearnset,
    [SPECIES_DIGLETT_ALOLAN] = sAlolanDiglettTMHMLearnset,
    [SPECIES_DUGTRIO_ALOLAN] = sAlolanDugtrioTMHMLearnset,
    [SPECIES_MEOWTH_ALOLAN] = sAlolanMeowthTMHMLearnset,
    [SPECIES_PERSIAN_ALOLAN] = sAlolanPersianTMHMLearnset,
    [SPECIES_GEODUDE_ALOLAN] = sAlolanGeodudeTMHMLearnset,
    [SPECIES_GRAVELER_ALOLAN] = sAlolanGravelerTMHMLearnset,
    [SPECIES_GOLEM_ALOLAN] = sAlolanGolemTMHMLearnset,
    [SPECIES_GRIMER_ALOLAN] = sAlolanGrimerTMHMLearnset,
    [SPECIES_MUK_ALOLAN] = sAlolanMukTMHMLearnset,
    [SPECIES_EXEGGUTOR_ALOLAN] = sAlolanExeggutorTMHMLearnset,
    [SPECIES_MAROWAK_ALOLAN] = sAlolanMarowakTMHMLearnset,
